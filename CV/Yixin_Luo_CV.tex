...
\ifcameraready%
\else%
\cventry{2017}{Peloton: A Self-Driving In-Memory Database}{Course Project}{}{}{
Developed a system catalog that supports non-blocking schema change and a concurrent lock-free skiplist index.
}
\fi%

\cventry{2017}{Multi-Agent Deep Reinforcement Learning}{Course Project}{}{}{
Developed DQN, DDPG, and MADDPG models for continuous multi-agent environment.
}

\cventry{2017}{Symbolic Information Processing for Question Answering}{Course Project}{}{}{
