...
\rhead{ \textit{Yixin Luo} } % put text in header (right side)
...
\address{{\bf Contact} \\
\emph{Cell phone:} (734) 546-7629 \\
\emph{Email:} \href{mailto:yixinluo@cmu.edu}{yixinluo@cmu.edu} \\
\emph{Webpage:} \href{http://www.yixinluo.com}{http://www.yixinluo.com} \\
}
...
\begin{itemize}[leftmargin=4mm]
  ...
  \item Yu Cai, Saugata Ghose, Erich F. Haratsch, \underline{Yixin Luo}, and Onur Mutlu,
        \href{https://arxiv.org/pdf/1706.08642}\emph{``Error Characterization, Mitigation, and Recovery in Flash Memory Based Solid-State Drives''},
  ...
  \item Yu Cai, Saugata Ghose, \underline{Yixin Luo}, Ken Mai, Onur Mutlu, and Erich F. Haratsch,
        \href{http://www.cs.cmu.edu/~yixinluo/index_files/two-step-programming-vulnerability_hpca17.pdf}\emph{``Vulnerabilities in MLC NAND Flash Memory Programming: Experimental Analysis, Exploits, and Mitigation Techniques''},
  ...
  \item Aya Fukami, Saugata Ghose, \underline{Yixin Luo}, Yu Cai, and Onur Mutlu,
        \href{http://www.cs.cmu.edu/~yixinluo/index_files/chip-off-forensic_dfrws17.pdf}\emph{``Improving the Reliability of Chip-Off Forensic Analysis of NAND Flash Memory Devices''},
  ...
  \item \underline{Yixin Luo}, Saugata Ghose, Yu Cai, Erich F. Haratsch, and Onur Mutlu,
        \href{http://www.cs.cmu.edu/~yixinluo/index_files/online-flash-channel-modeling_jsac16.pdf}\emph{``Enabling Accurate and Practical Online Flash Channel Modeling for Modern MLC NAND Flash Memory''},
  ...
  \item \underline{Yixin Luo}, Yu Cai, Saugata Ghose, Jongmoo Choi, and Onur Mutlu,
        \href{http://www.cs.cmu.edu/~yixinluo/index_files/write-hotness-aware-retention-management_msst15.pdf}\emph{``WARM: Improving NAND Flash Memory Lifetime with Write-hotness Aware Retention Management''},
  ...
  \item Arun Raghavan, \underline{Yixin Luo}, Anuj Chandawalla, Marios C. Papaefthymiou, Kevin P. Pipe, Thomas F. Wenisch, Milo M. K. Martin.
        \href{http://www.cs.cmu.edu/~yixinluo/index_files/computational-sprinting_hpca12.pdf}\emph{``Computational Sprinting''},
        ...
        \emph{One of the 11 computer architecture papers of 2012 selected as Top Picks by IEEE Micro.}
\end{itemize}
...
\begin{itemize}[leftmargin=4mm]
  ...
  \item \href{http://www.cs.cmu.edu/~yixinluo/index_files/online-flash-channel-modeling_fms16-talk.pptx}\emph{``Online Flash Channel Modeling and Its Applications''},
        Flash Memory Summit (FMS), 2016.
  \item \href{http://www.cs.cmu.edu/~yixinluo/index_files/data-retention_fms15.pptx}\emph{``Data Retention in MLC NAND Flash Memory''},
        Flash Memory Summit (FMS), 2015.
  \item \href{http://www.cs.cmu.edu/~yixinluo/index_files/write-hotness-aware-retention-management_msst15-talk.pptx}\emph{``WARM: Improving NAND Flash Memory Lifetime with Write-hotness Aware Retention Management''},
        International Conference on Massive Storage Systems and Technology (MSST), 2015.
  \item \href{http://www.cs.cmu.edu/~yixinluo/index_files/read-disturb-errors_dsn15-talk.pptx}\emph{``Read Disturb Errors in MLC NAND Flash Memory''},
        International Conference on Dependable Systems and Networks (DSN), 2015.
  \item \href{http://www.cs.cmu.edu/~yixinluo/index_files/flash-memory-data-retention_hpca15-talk.pptx}\emph{``Data Retention in MLC NAND Flash Memory''},
        IEEE Symposium on High Performance Computer Architecture (HPCA), 2015. {\bf (Best Paper Session)}
  \item \href{http://www.cs.cmu.edu/~yixinluo/index_files/heterogeneous-reliability-memory_dsn14-talk.pptx}\emph{``Optimizing Datacenter Cost via Heterogeneous Reliability Memory''},
...
\begin{itemize}[leftmargin=4mm] \itemsep -2pt % reduce space between items
  \item \emph{Lanuages:} {\tt C/C++}, {\tt Perl/Python}, {\tt Linux Shell}, \LaTeX, {\tt Verilog}, {\tt Windows Batch script}
  \item \emph{Tools:} {\tt Matlab}, {\tt Intel Pin}, {\tt HSPICE}, {\tt Cadence tools}
  \item \emph{Simulators:} {\tt gem5}, {\tt Multi2Sim}
  \item \emph{Others:} {\tt Hadoop}, {\tt MySQL}
\end{itemize}
